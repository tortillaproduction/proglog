...
const file_api_v1_log_proto_rawDesc = "" +
	"\n" +
	"\x10api/v1/log.proto\x12\x06api.v1\"6\n" +
	"\x06Record\x12\x14\n" +
	...
	"\x06record\x18\x01 \x01(\v2\x0e.api.v1.RecordR\x06record2\x8f\x02\n" +
	"\x03Log\x12<\n" +
	...
	"\rProduceStream\x12\x16.api.v1.ProduceRequest\x1a\x17.api.v1.ProduceResponse\"\x00(\x010\x01B5Z3github.com/tortillaproduction/proglog/api/v1;log_v1b\x06proto3"
