...
const file_api_v1_log_proto_rawDesc = "" +
	"\n" +
	"\x10api/v1/log.proto\x12\x06api.v1\"^\n" +
	"\x06Record\x12\x14\n" +
	...
	"\x06record\x18\x01 \x01(\v2\x0e.api.v1.RecordR\x06record\"\x13\n" +
	"\x11GetServersRequest\">\n" +
	"\x12GetServersResponse\x12(\n" +
	"\aservers\x18\x01 \x03(\v2\x0e.api.v1.ServerR\aservers\"P\n" +
	"\x06Server\x12\x0e\n" +
	...
	"\n" +
	"GetServers\x12\x19.api.v1.GetServersRequest\x1a\x1a.api.v1.GetServersResponse\"\x00B5Z3github.com/tortillaproduction/proglog/api/v1;log_v1b\x06proto3"
...
var file_api_v1_log_proto_goTypes = []any{
	...
	(*GetServersRequest)(nil),  // 5: api.v1.GetServersRequest
	(*GetServersResponse)(nil), // 6: api.v1.GetServersResponse
...
var file_api_v1_log_proto_depIdxs = []int32{
	...
	1, // 3: api.v1.Log.Produce:input_type -> api.v1.ProduceRequest
	3, // 4: api.v1.Log.Consume:input_type -> api.v1.ConsumeRequest
	3, // 5: api.v1.Log.ConsumeStream:input_type -> api.v1.ConsumeRequest
	1, // 6: api.v1.Log.ProduceStream:input_type -> api.v1.ProduceRequest
	5, // 7: api.v1.Log.GetServers:input_type -> api.v1.GetServersRequest
	2, // 8: api.v1.Log.Produce:output_type -> api.v1.ProduceResponse
	4, // 9: api.v1.Log.Consume:output_type -> api.v1.ConsumeResponse
	4, // 10: api.v1.Log.ConsumeStream:output_type -> api.v1.ConsumeResponse
	2, // 11: api.v1.Log.ProduceStream:output_type -> api.v1.ProduceResponse
	6, // 12: api.v1.Log.GetServers:output_type -> api.v1.GetServersResponse
