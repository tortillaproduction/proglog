...
A distributed commit log service built in Go, designed as a hands-on project to understand the core concepts of distributed systems. This repository is based on the book *"Distributed Services with Go"* by Travis Jeffery.
